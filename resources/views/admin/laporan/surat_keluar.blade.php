...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-lg font-semibold text-slate-800" style="font-family: 'Georgia', serif;">Laporan Surat Keluar</h1>
        </div>
    </div>
    ...
    <div class="bg-white border border-stone-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <form action="{{ route('laporan.surat-keluar') }}" method="GET" class="p-5">
            <div class="flex flex-col sm:flex-row gap-4 items-end">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('laporan.cetak-pdf', ['jenis' => 'surat_keluar', 'dari' => request('dari'), 'sampai' => request('sampai')]) }}"
                       target="_blank"
    ...
    <div class="border border-stone-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="px-5 py-3.5 bg-stone-50 border-b border-stone-200 flex items-center justify-between">
            <p class="text-[11px] uppercase tracking-[0.15em] text-slate-400 font-medium">Data Surat Keluar</p>
            ...
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="border-b border-stone-200 bg-stone-50/60">
                        ...
                        <th class="px-5 py-3.5 text-[11px] uppercase tracking-[0.15em] text-slate-400 font-medium">Tujuan</th>
                        <th class="px-5 py-3.5 text-[11px] uppercase tracking-[0.15em] text-slate-400 font-medium">Perihal</th>
                        <th class="px-5 py-3.5 text-[11px] uppercase tracking-[0.15em] text-slate-400 font-medium">Kategori</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-stone-100 bg-white">
                    @forelse($data as $key => $item)

                    {{-- Parse data_isian: bisa berupa array (sudah di-cast) atau string JSON --}}
                    @php
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-14 text-center">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <p class="text-sm text-slate-400">Tidak ada data surat keluar.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
