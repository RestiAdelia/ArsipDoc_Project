        ...
        <div class="overflow-x-auto border border-stone-200 rounded-2xl shadow-sm">
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="border-b border-stone-200 bg-stone-50">
                        ...
                        <th class="px-5 py-3.5 text-[11px] uppercase tracking-[0.15em] text-slate-400 font-medium">Nomor
                            Surat</th>
                        <th class="px-5 py-3.5 text-[11px] uppercase tracking-[0.15em] text-slate-400 font-medium">Template
                        </th>
                ...
                <tbody class="divide-y divide-stone-100 bg-white">
                    @forelse($data as $k => $s)
                        <tr
                            x-show="filterRow('{{ strtolower($s->nomor_surat) }} {{ strtolower($s->template->nama_template ?? '') }}')">
