        ...
        <div class="bg-white border border-stone-200 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 overflow-hidden flex flex-col">
            ...
            <div class="px-6 pt-5 pb-4 border-b-2 border-double border-stone-300 bg-stone-50">
                <div class="flex items-start justify-between gap-2">
                    ...
                    <span class="inline-flex px-2 py-0.5 text-[10px] font-medium text-slate-500 bg-white border border-stone-200 rounded-lg">
            ...
            {{-- Aksi --}}
            <div class="px-5 py-3.5 border-t border-stone-100 flex gap-2">
                <button onclick="openPreview(this)"
                        data-template="{{ addslashes(strip_tags($t->isi_template)) }}"
                        class="flex-1 inline-flex items-center justify-center gap-1.5 py-2 text-xs font-medium text-slate-500 hover:text-slate-800 bg-stone-50 hover:bg-stone-100 border border-stone-200 rounded-lg transition-colors duration-150">
                ...
                <a href="{{ route('template.form', $t->id) }}"
                   class="flex-1 inline-flex items-center justify-center gap-1.5 py-2 bg-slate-900 hover:bg-slate-700 text-white text-xs font-medium rounded-lg transition-colors duration-150">
                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
    ...
    <div class="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-xl border border-stone-200">
        ...
        <div class="px-10 py-8" style="font-family: 'Times New Roman', serif;">
                    ...
                    <tr>
                        <td style="width: 80px; text-align: center; vertical-align: middle; padding-right: 10px;">
                            <img src="{{ asset('storage/instansi/logo.png') }}"
                                 style="height: 64px; width: auto; object-fit: contain;" alt="Logo"
            ...
            <div style="margin-bottom: 10px; font-size: 12px; line-height: 1.6;">
                ...
                <p style="margin: 0;">Kepala / Pimpinan yang Bersangkutan</p>
                <p style="margin: 0;">di &ndash; <u>Tempat</u></p>
            </div>
            ...
            <div style="display: flex; justify-content: flex-end; margin-top: 24px;">
                <div style="text-align: center; font-size: 11px; color: #64748b; width: 200px;">
                    <p style="margin: 0;">............, .................. {{ date('Y') }}</p>
                    <p style="margin: 4px 0 0 0;">Pejabat Berwenang,</p>
                    <div style="height: 48px;"></div>
                    <p style="font-weight: bold; text-decoration: underline; color: #1e293b; margin: 0;">( Nama Pejabat )</p>
