...
<div class="max-w-2xl mx-auto space-y-5">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-lg font-semibold text-slate-800" style="font-family: 'Georgia', serif;">Input Dokumen Baru</h1>
        </div>
    ...
    <div class="bg-white border border-stone-200 rounded-2xl shadow-sm overflow-hidden">
        <form action="{{ route('dokumen.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-8 py-7 space-y-5">
                ...
                <!-- Nama Dokumen -->
                <div>
                    <label class="block text-[11px] uppercase tracking-[0.2em] text-slate-400 font-medium mb-2">Nama Dokumen / Perihal</label>
                ...
                <div class="border border-dashed border-stone-300 bg-stone-50/60 rounded-xl px-5 py-4 space-y-2">
                    <label class="block text-[11px] uppercase tracking-[0.2em] text-slate-400 font-medium">
                        Upload File
                        <span class="normal-case tracking-normal text-slate-300 ml-1">(PDF / DOC)</span>
                    </label>
